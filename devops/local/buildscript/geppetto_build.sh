...
DESKTOPCODE='../../../application/client/desktop/seven_7783'
DESKTOPIMAGENAME='geppettotest/seven_7783-desktop:1.0'
...
helm install --name seven_7783 ./helm
if [ $? -eq 0 ]; then
